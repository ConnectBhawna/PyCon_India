...
from pygame.locals import * #initilising
import random # importing dependency for generating random values and numbers 
...
# set window title
pygame.display.set_caption("Bhawna's car game")
